...
namespace DuiLib {
#define UI_WNDSTYLE_FRAME      (WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS)
#define UI_WNDSTYLE_CHILD      (WS_VISIBLE | WS_CHILD | WS_CLIPSIBLINGS | WS_CLIPCHILDREN)
#define UI_WNDSTYLE_DUI	       (WS_POPUP | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_SYSMENU | WS_SIZEBOX | WS_MAXIMIZEBOX | WS_MINIMIZEBOX)
...
public:
	...
	virtual TNotifyUI* UnpackMessage(TNotifyUI& msg, TNotifyUI* out){return &msg;}
